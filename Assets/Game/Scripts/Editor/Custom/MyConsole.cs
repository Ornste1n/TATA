...
namespace Game.Scripts.Custom
{
    public class MyConsole : EditorWindow
    {
        ...
        private void InitFields()
        {
            ...
            root.Q<Button>("logs-open").RegisterEvent<ClickEvent>(CheckCallback, _handlers, OpenGraphics);
            root.Q<Button>("graphics-open").RegisterEvent<ClickEvent>(CheckCallback, _handlers, OpenGraphics);
            
            //root.Q<Button>("errors-open").RegisterEvent<ClickEvent>(RegisterCallback, _handlers, _);
        }
        ...
        private void OpenGraphics() => OpenFile(Paths.Graphics);
